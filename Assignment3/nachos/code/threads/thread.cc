...
List<Thread*>* Thread::allThreads = new List<Thread*>();
...
Thread* Thread::getByID(int tId){
	ListIterator<Thread*> *li = new ListIterator<Thread*>(allThreads);
	while(!li->IsDone()){
        Thread *t = li->Item();
...
Thread* Thread::getByName(string tName){
	ListIterator<Thread*> *li = new ListIterator<Thread*>(allThreads);
	while(!li->IsDone()){
        Thread *t = li->Item();
		if(t->getName() == tName)
